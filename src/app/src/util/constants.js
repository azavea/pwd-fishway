...
export const ABOUT_PROFILES = [
    {
        ...
        job: '',
        descriptionIntro:
            'When the Fairmount Dam was installed, it helped bring water to people, but was detrimental to fish swimming upstream to their natural spawning grounds who couldn’t swim up and over the dam to cross to the other side.',
        description:
...
export const FISH_CATALOG = [
    {
        ...
        overview: [
            ...
            'By 1931, the alewife was reported in Lake Erie, having bypassed Niagara Falls via the Welland Canal. As a food fish for larger game fish, alewives have also been stocked in impoundments across the state. They have also been accidentally spread as escapees from fishermen’s bait buckets. Its small size, large schools and availability to openwater game fish have made the alewife suited for stocking in some inland reservoirs as a forage fish.',
            'It has been introduced in Pennsylvania for that purpose in some of our larger impoundments. The species name “pseudoharengus” means “false herring.”',
        ],
        characteristics: [
            'On the exterior, the alewife is nearly identical to the closely related blueback herring. The surest difference is inside the fish. The alewife has a silver-gray lining (peritoneum) to its body cavity. The blueback’s peritoneum is black. Alewives are bluish green or bluish gray on the back, silvery on the sides, with faint, dark stripes.',
            'They have a large eye that is wider than the distance between the front of the snout to the front of the eye. Like the blueback herring, alewives have a single dark spot behind the upper gill cover, and the rear edge of the upper jaw extends to the middle of the eye. The alewife’s lower jaw does not project noticeably beyond the upper jaw. Like the American shad, the alewife has a deep notch in its upper jaw.',
            'Saltwater alewives seldom weigh over one pound. Their maximum length is 12 to 15 inches. Landlocked freshwater alewives rarely go more than nine inches. The usual size is three to six inches.',
        ],
        habitat: [
    ...
    },
    {
        ...
        overview: [
            'Freshwater eels are the only catadromous fishes in North America. “Catadromous” means that they spawn in salt water and live as adults in fresh water. Anadromous fishes, like salmon and American shad, spawn in fresh water but live as adults in the ocean. On this continent, eels are represented by a single species, the American eel (Anguilla rostrata).',
            'Although the eel looks snakelike, it is a fish. The American eel is found widely along the Atlantic and Gulf coasts, where the young eels move far upstream into small tributaries. The Delaware River in Pennsylvania has the most abundant population of eels of all the state’s streams, because there are no dam obstructions to prevent the eel’s upriver migration.',
            'Eels are rarely found in the Susquehanna River system. Passageways and lifts to move fish past all the Susquehanna’s dams should soon return eels, shad and other ocean-migrating fish to that watershed. Eels are also occasionally seen in the Potomac River watershed. They have even been reported from some headwater sections of the Ohio River watershed in Pennsylvania.',
            'While in fresh water, eels live in a variety of stream habitats, especially where they can hide under logs, rocks and undercut banks. Until the early 1900s, eels supported an intense commercial fishery in the Susquehanna and Delaware River systems. Adult eels on their downstream migration toward the sea were trapped by low, in-river V-shaped wing dams, which were barricades made of rocks.',
            'The eels entered these eel racks from the wide upstream side and swam through the small funnel opening downstream, into holding baskets. The remains of old “eel weirs” can still be seen in some Delaware and Susquehanna River watershed streams. Even in a “poor” eel year, the take was staggering: In 1912, called an “off year,” 50,000 eels weighing more than 44,000 pounds were caught in Pennsylvania.',
            'Today, eels are caught mostly by anglers (a person who uses a hook to fish) looking for food and sport (eels are good eating, especially smoked). The genus name “Anguilla” is Latin for “eel.” The species name “rostrata” means “long nose.”',
        ],
        characteristics: [
            'The American eel’s body is long and slender, and seems scaleless. Actually, it has smooth, tiny scales that are embedded in the skin. A long, low dorsal fin extends over at least two-thirds of the back. It blends with the caudal fin and the anal fin, which is also long and low, on the underside. There are no pelvic fins, but the pectoral fins are well-developed. The presence of pectoral fins can be used to distinguish an eel from a lamprey, which has no paired fins.',
            'The head has a smallish eye. The head is long, and tapers to a small mouth. The lower jaw sticks out a little farther than the upper jaw. Eels are yellowish brown to dark-olive, and lighter underneath. In Pennsylvania, the maximum size is two to three feet, although four feet or more is possible. Females grow larger than males.',
        ],
        habitat: [
            'Found in a variety of habitats including streams, rivers and muddy or silt-bottomed lakes during their freshwater stage, as well as oceanic waters, coastal bays and estuaries.',
        ],
        lifespan: [
            ...
            'After remaining in fresh water for 10 to 20 years, the adult females, now called “silver eels” because of their silvery appearance, migrate downstream in the fall on their long way back to the Sargasso Sea. Sexually mature female eels may contain two million or more eggs.',
    ...
    },
    {
        ...
        characteristics: [
            'Female shad, carrying their eggs during the spawning run, average four to five pounds, with a six- or seven-pounder fairly common. The males are smaller for their age. Shad can grow to 30 inches, with a maximum weight of about 12 pounds. Shad are brilliantly silver on the sides, with a greenish or bluish-metallic sheen on the back.',
            'The scales are large and readily detach when the fish is handled. Shad have one to two, rarely three, rows of dark spots extending along the side from the back edge of the gill cover. The first spot is the largest. The body is deep from the side and narrow seen head-on.',
            'Shad have sharp-edged modified scales along the belly line, as do other herrings. The dorsal fin is at the center of the back, and the tail is deeply notched. The dorsal and caudal fins are dusky. The caudal fin has a black edge, and the other fins are clear to light-green. The upper and lower jaws are about equal in length, neither jutting past the other. The rear corner of the upper jaw extends to the rear edge of the large eye.',
            'The head has a short, triangular look. The shad is notorious for its thin, easily torn mouth tissue.',
        ],
        habitat: [
        ...
        lifespan: [
            'Shad run upriver from salt water into fresh water on their spring spawning migration when the water temperature is in the mid-50s to 60 degrees, with peak spawning activity occurring at about 65 degrees. The males travel upriver in schools ahead of the females.',
            'Shad spawn over sandbars or rocky riffles at night. Females, which are larger than the males, produce 100,000 eggs as an average, with 300,000 a documented high. Shad eggs are not adhesive and are just slightly heavier than water, so they do not readily sink. Instead, they drift along with the current. They develop and hatch in eight to 12 days, depending on water temperature. Adult shad feed little on their upstream spawning run, although they strike anglers’ offerings. The spawned-out, or spent, fish do eat on their way downriver to the sea again.',
            'Hatched shad live several months in fresh water, reaching the ocean by their first autumn. Shad stay in salt water for four or five years and until they are about 18 inches long, when they become sexually mature. Then they make their first freshwater spawning run. Some return to their home streams, but others show no migratory pattern.',
            'Shad feed mostly on microcrustaceans, or zooplankton, as well as some worms and small fish. While in fresh water, the young feed on insect larvae.',
        ],
    },
    {
        ...
        overview: [
            ...
            'Throughout its range, dams have blocked the blueblack from entering streams, and reduced its abundance and distribution in freshwater. South of Pennsylvania, blueback herring can be very common in river mouths in the spring, giving it the common name “glut herring.”',
        ],
        characteristics: [
            'Blueback herring look like alewives, with which they associate. The main difference between the alewife and blueback herring is internal: The alewife has a silver-gray lining (peritoneum) to its body cavity. The blueback’s peritoneum is black. The eye of the blueback is smaller, comparatively, than the alewife’s eye.',
            'Bluebacks have a single blue-black spot behind the upper part of the gill cover on the side of the body. The back is blue-green and the body sides are bright-silver. The cheek is longer than it is deep. The lower jaw projects slightly beyond the upper jaw, giving them a “stick out your chin” look.',
            'Bluebacks are generally more slender than alewives and are darker in color than other members of the herring family. The maximum size is about 15 inches and less than one pound. As in the other herrings, there is a row of saw-toothed scales along the belly line. There is also one dorsal fin, and the tail is deeply forked.',
        ],
        habitat: [
    ...
    },
    {
        ...
        lifespan: [
            'Bluegills spawn during a longer period than most sunfish, from May, when the water temperature reaches 67 degrees, until August. The males fan small, saucerlike depressions in sand and gravel as nests, and vigorously guard the eggs and hatched young.',
            'Large numbers of nests are often in the same area and form colonies. One female may deposit as many as 38,000 eggs in a nest. Bluegill eggs hatch in two to five days. Because several females have contributed, there may be more than 60,000 young fish produced from a single nest. Bluegills may overpopulate their habitat, resulting in smaller and slower-growing fish.',
            'As generalized feeders, bluegills eat aquatic insects, crustaceans and minnows, and they have been known to eat aquatic plants. The bluegill feeds only in the daytime and throughout the water column. It may grow to a foot long and up to two pounds, although nine inches is an average.',
        ],
    },
    {
        ...
        overview: [
            ...
            'Brown trout are considered more difficult to catch than brook trout. The larger ones tend to feed at night. Brown trout are closely related to Atlantic salmon (Salmo salar). The genus name “Salmo” is the Latin name for the Atlantic salmon. The species name “trutta” is the Latin name for “trout.”',
        ],
        characteristics: [
        ...
        habitat: [
            'The brown trout lives in cold or cool streams, rivers, lakes and impoundments. It is more tolerant of siltation and higher water temperatures than brook trout.',
            ...
            'Some brown trout can “hold over” after they are stocked. They can last a year or more in a stream, because they are adaptable to stream changes and are not that easy to catch.',
        ],
        lifespan: [
            'Brown trout spawn in the fall, a little later than brook trout, when water temperatures are in the mid-40s to high 40s. Eggs are deposited in a stream gravel depression that the female prepares with swimming actions of her fins and body.',
            'Large females produce 4,000 to 12,000 eggs. Several males may accompany the female during spawning. The eggs hatch the following spring, with no parental attention. Brown trout eat aquatic and terrestrial insects, crayfish and other crustaceans, and especially fish. The big ones may also eat small mammals (like mice), salamanders, frogs and turtles.',
            'Large browns feed mainly at night, especially during the summer. Their life span in the wild can be 10 to 12 years.',
        ],
    },
    {
        ...CHANNEL_CATFISH,
        overview: [
            'Next to the flathead catfish, the channel catfish is the largest catfish in Pennsylvania. Weights of up to 15 pounds are not unusual at lengths of about 30 inches. The state record is over 35 pounds.',
            'Channel “cats” are avidly sought sport fish and are raised commercially for the table. They are found statewide, introduced where they did not occur naturally. The native range of channel catfish is believed to be the Great Lakes and St. Lawrence River watershed, the Missouri River system, the Mississippi River watershed, Gulf of Mexico watershed and parts of Mexico.',
            'They were not native to the Atlantic Coast north of Florida. The channel catfish’s species name “punctatus” means “spotted,” referring to the small, dark spots on its sides. The channel catfish is the only catfish that has these dots.',
        ],
        characteristics: [
            ...
            'Except for some large adults, especially the males, channel catfish have small, irregular spots on the sides and back. None of the other catfishes has these spots. Males become darker, almost blue-black, during spawning time.',
        ],
        habitat: [
            'The channel catfish is an adaptable fish, usually found in clear, warm lakes and moderately large to large rivers, over clean sand, gravel or rock-rubble bottoms. It is generally not found in the muddied, weed-choked waters that some other catfish species frequent.',
            'Channel cats, especially young fish, may be found in fast-flowing water. Usually, channel catfish prefer deep pools and runs in rivers that have alternating pool and riffle habitats. It is also found in reservoirs, lakes and farm ponds, and even in some of the larger trout streams.',
        ],
        lifespan: [
            ...
            'In clear ponds, spawning channel cats must have semi-darkened shelters, either natural or provided. From reservoirs, channel catfish sometimes move upstream to spawn in tributary rivers. A female channel cat may lay 2,000 to 70,000 eggs per year, depending on her size. After spawning, the males protect the adhesive egg mass and aerate and clean the eggs by fanning their fins. The males also guard the hatched fish for a time.',
            'Young channel cats are insect-eaters, feeding on mayfly nymphs, caddis larvae and midge larvae. As they grow, they switch to fish, crayfish and mollusks, but still feed on aquatic insects, and occasionally eat plant matter. Yearling and subadult channel cats are more tolerant of fast water than larger adults. They move out of slow water into the quicker current or swim short distances into tributary streams to feed.',
            'Channel cats feed mostly at night, but may forage on the bottom, where it’s dim during the day. Channel catfish, especially young fish, have been known to feed on the surface. Like other catfish, at night they depend on their barbels and their sense of taste to find food.',
            'Even so, channel cats are believed to be more of a sight-feeder than other catfishes, because of their clear-water habitat.',
        ],
    },
    {
        ...COMMON_CARP,
        overview: [
            ...
            'By 1880, the U.S. Fish Commission had distributed more than 12,000 carp to people in 25 states and territories to establish the fish in this country. Today, carp are found not only throughout the United States, where they are especially abundant in the fertile waters of the Mississippi River watershed, but they occur in all 67 Pennsylvania counties. Young carp are an important part of the aquatic food base. Larger carp are a fisherman’s challenge because of their tackle-testing weight.',
            'Carp are also pursued by bow fishermen, especially when the fish move into shallow water to spawn. The genus name “Cyprinus” is the old-world name for carp. “Carpio” is a Latinized word meaning “carp.”',
        ],
        characteristics: [
            'Carp can be confused with feral (wild) goldfish, except that the carp grows much larger and has two pairs of soft, fleshy barbels around its mouth. Goldfish don’t have these barbels. The carp’s body is robust, deep and thick, and arched toward the dorsal fin. It has large scales that are dark-edged, with a black spot at the base.',
            'Most carp are heavily scaled, but two genetic mutants show either few, extremely large scales (the “mirror carp”) or no scales at all (the “leather carp”). Carp have a lengthy dorsal fin, with nearly 20 soft rays. The dorsal fin extends well along the back. The dorsal and anal fins have a sharp “spine,” actually, a hardened soft ray, on the front edge.',
        ...
        habitat: [
            'Carp tolerate a variety of habitats, even heavily silted water or polluted water that most other fish cannot tolerate. They can also be found in clean streams, including the larger trout streams. When carp live in rivers, they inhabit the slower-flowing sections. They are also in ponds, lakes and reservoirs. Carp prefer shallow areas with plenty of underwater weed growth. But they can be found over any type of bottom, including mud, sand or gravel.',
            'Carp create their own turbidity, muddying the waters during their bottom-rooting feeding. They have been blamed for contributing to the decline of clean-water native fish, because their silt-stirring activities decrease light penetration. This inhibits plant growth, and causes mud to settle on and suffocate developing fish eggs.',
        ],
        lifespan: [
            ...
            'Several males may spawn with a female, which can release up to two million tiny eggs. The carp parents abandon the eggs. The eggs adhere to submerged vegetation and to the bottom. They hatch in four or five days. Carp grow to four or five inches their first year. They mature in three or four years, and they can live to be about 20 years old.',
            'The carp is an omnivore, eating a wide variety of aquatic plants, algae, insect larvae and other invertebrates, and even small fish. Its usual feeding method is to disturb the bottom material with its snout and pick up the food it dislodges, usually kicking up clouds of silt.',
            'Carp have a well-developed sense of taste and a sensitive mouth. Their pharyngeal “teeth,” located in the throat, are adapted for crushing. The larger ones look like human molars.',
        ],
    },
    {
        ...
        overview: [
            'Flathead catfish grow longer and heavier than other Pennsylvania catfish. In fact, they are one of the state’s biggest fish, of any kind. Flathead catfish are known to grow to more than 100 pounds, but 20 or 30 pounds is more likely in Pennsylvania. The Pennsylvania record is over 40 pounds.',
            'Flathead catfish are native to the lower Great Lakes and the Mississippi River basin, from western Pennsylvania southward. They are also in Gulf of Mexico watersheds, and can live in reservoirs. In Pennsylvania, flatheads are found mainly in the Ohio, Allegheny and Monongahela rivers. Fossils of this catfish genus that are about 15 million years old, from the mid-Miocene Epoch, can’t be distinguished from the modern flathead catfish.',
            'The flathead’s genus name “Pylodictis” means “mud fish,” and its species name “olivaris” means “olive-colored.”',
        ],
        characteristics: [
            'Flathead catfish have the scaleless, strong body and the well-developed pectoral and dorsal fin spines typical of catfish. The tail is only slightly indented, or may appear square or rounded. The dorsal fin is high, and the lower jaw projects past the upper jaw. The body looks long and slender.',
            'The upper portion of the flathead catfish’s body is yellowish brown to dark, even purplish brown, with black or brown mottling on lighter brown sides. The belly is grayish or yellowish white. It does have a flat-looking head, very wide and depressed. The chin barbels are white to yellow, the fins are mottled, and the anal fin, which has fewer than 16 rays, is short and rounded.',
            'Except for very large adults, flathead catfish have a white tip on the upper lobe of the caudal fin. Young flathead catfish are nearly black on the back.',
        ],
        habitat: [
        ...
        lifespan: [
            'The flathead is a loner and a traveler, leading a solitary existence except at spawning time. Flatheads spawn in early summer, later than channel catfish. The flathead’s spawning behavior is like that of other catfish. The adults form pairs and build nests in natural cavelike depressions in the bank, or they may hollow out a cavity under an underwater object, like a log or boulder.',
            'Their compact egg masses contain from 4,000 to 100,000 eggs. The male guards the nest and the newly hatched fry, becoming aggressive toward the female. Flatheads grow fairly rapidly and mature sexually at about 15 inches and five years old. They can live to at least 19 years old. Juvenile flatheads live in riffle areas and feed on larvae and nymphs of aquatic insects. As the flathead grows, it switches to crayfish and fishes, although many items are on its menu.',
            'During the day, flathead catfish stay out of sight, hiding beneath undercut banks, in brush piles and log jams. At night they forage in a variety of habitats, including very shallow riffles where their backs and dorsal fins may be exposed. For this reason, angling at night is the way to catch a big flathead. Biologists report that one possible feeding strategy of the flathead is to lie motionless with its mouth open, until a fish looking for a spot in which to hide swims in.',
    ...
    },
    {
        ...
        overview: [
            'The gizzard shad is a herring with a difference. It is set apart from its herring relatives (that are in the genus Alosa), by its gizzardlike stomach. The gizzard shad is found mainly in the Ohio River watershed and Lake Erie in appropriate habitat.',
            'However, as a result of both intentional and unintentional stocking, it is found statewide. The gizzard shad’s original home range was the southeastern United States, except for the Appalachian Mountains, but the fish seems to be spreading northward. Biologists question whether or not the gizzard shad was native to Lake Erie. They believe it probably invaded the Great Lakes from the upper Mississippi River.',
            'Today, gizzard shad can be found in the St. Lawrence River, the Great Lakes, the Mississippi River and its tributaries, and the Atlantic and Gulf Coast watersheds. The gizzard shad gets its common name from its muscular, gizzardlike stomach, which helps process the plankton and plant food this fish strains from the water. The genus name “Dorosoma” refers to a lancelike body. The species name “cepedianum” recognizes a French ichthyologist named Lacepede.',
        ],
        characteristics: [
            'The gizzard shad has the typical herring family shape, but with a distinctive dorsal fin. Its short, soft-rayed dorsal fin is located at the center of its back. It has a long, trailing filament as the rear ray, longer than any of the other rays. The gizzard shad’s back is silvery blue-green to gray. The sides are silvery or reflect blue, green, brassy or reddish tints. There is no lateral line. The tail is deeply forked, and the lower jaw is slightly shorter than the upper jaw. The snout is blunt. The mouth is small, and there is a deep notch in the center of the upper jaw. The gizzard shad’s eye is large.',
            'There is a big, purplish-blue spot near the edge of the upper gill in young gizzard shad and small adults. This spot is faint or disappears completely in larger, older fish. The fins are dusky and there are the usual herring sawtooth- edged belly scales. Gizzard shad grow rapidly and can reach a maximum size of about 20 inches.',
        ],
        habitat: [
        ...
        lifespan: [
            'The gizzard shad spawns in spring, May to June, when water temperatures reach the mid-60s to mid-70s. Spawning gizzard shad gather in large schools to broadcast their eggs in water several feet deep, near the shore. The actual spawning is done near the surface.',
            'The females participate with several males. An average female gizzard shad produces about 300,000 eggs, but some may expel a half-million, with maximum production by two-year-old fish. After releasing their eggs and milt, the adults return to the water depths. The sticky eggs fall to underwater roots, plant fibers and other debris. There they adhere and hatch in two or three days.',
            'Young gizzard shad are a food source for game fish, but grow rapidly, to as much as seven inches their first year. Their use as a forage fish is limited because they quickly grow past the prey size preferences of all but the largest predatory fish. In some fertile waters, gizzard shad become numerous, and extensive winter die-offs are not uncommon. Winter die-offs are associated with temperature stress.',
            'Massive mortality of gizzard shad may also follow spawning. Gizzard shad are filter-feeders, straining small animal organisms and plants from bottom mud and organic deposits. The adults have very many, often more than 400, fine gill rakers that can catch even minute plankton. Gizzard shad have an unusual digestion process for fish. The vegetable material they eat is ground in a gizzardlike stomach.',
        ],
    },
    {
        ...
        characteristics: [
            'The green sunfish’s back and sides are olive, with a blue- green sheen and small, scattered dark specks. The lower sides and the belly have a brassy- gold tint and the head has bright-blue spots or lines.',
            'The gill flap is black with a pale-red, pink or yellow edge, and the pectoral fins are short and rounded. There is a black blotch on the rear portion of the dorsal fin and at the base of the anal fin.',
            'The green sunfish’s mouth is larger and the lips are heavier than in most sunfish. The top jaw extends past the front of the eye. Dorsal, caudal and anal fins are edged with a white, yellow or orange border. Green sunfish reach eight or nine inches in length.',
        ],
        habitat: [
        ...
        lifespan: [
            'Green sunfish spawn over several months, between June and August. The fish mature at two years of age, although they may be only three inches long. The males fan several dishlike depressions in the bottom with the tail, and defend the nests vigorously against other green sunfish males.',
            'Green sunfish may nest in colonies, and readily hybridize with other sunfish, like bluegills and pumpkinseeds. The females spawn 2,000 to 10,000 eggs onto the nests of several males, and the males stay with the nest about a week while the eggs develop.',
            'Green sunfish are prolific producers. They tend to overpopulate the shallow water areas where they live. Their rather large mouth lets them eat insects, snails, crayfish and even small fish.',
        ],
    },
    {
        ...
        overview: [
            ...
            'Like American shad, hickory shad are anadromous. They live in coastal ocean waters as adults and enter brackish estuaries, like the Delaware, and swim far upstream to spawn in freshwater rivers and creeks. Hickory shad are returning to the Susquehanna River watershed because of fish lifts on dams. Currently, they are on the list of endangered, threatened, and candidate fishes because of their extremely limited distribution and abundance.',
            'In states where their numbers are sufficient to allow sport fishing, they are pursued by light-tackle specialists for their fighting and leaping abilities.',
        ],
        characteristics: [
            ...
            'The hickory shad’s shape is unique. The back curves only slightly. The body is long but compressed. In cross section it is wedge-shaped. The hickory shad ranges in size between the bigger American shad and the smaller blueback herring and alewife.',
        ...
        lifespan: [
            ...
            'Spawning is believed to take place at night, between dusk and around midnight, when water temperatures reach 61 degrees. The eggs, which are buoyant and somewhat adhesive, are easily carried downstream by swift water and current. The eggs hatch in 48 to 70 hours.',
        ],
    },
    {
        ...
        overview: [
            'Largemouth bass were originally distributed in the Ohio River and Lake Erie watersheds in Pennsylvania. The largemouth has been established statewide in appropriate habitat. The largemouth bass is Pennsylvania’s biggest sunfish. The state angling record is over 11 pounds, and the fish can grow two feet or more in length.',
            'The largest largemouths are generally females. The species name “salmoides” refers to trout (“salmo”), because the largemouth is sometimes called a “trout” in the southern United States. One nickname is “bucketmouth,” which, like the common name “largemouth,” is well-deserved by the fish’s gaping jaw, with which it can swallow sizable prey.',
        ],
        characteristics: [
    ...
    },
    {
        ...
        characteristics: [
            ...
            'Muskies vary in the color and the intensity of their markings. The base color on the back and sides is light greenish gray or yellow-green to olive-brown, the sides shading lighter. The flanks have more or less vertical rows of darker spotting, or indistinct bars. The striping is more pronounced in younger fish. In older fish it may fade, giving the fish a uniform color. The musky’s belly is white. Its fins are greenish cream to brownish orange, with dark blotches. There is no dark teardrop mark below the eye. Instead, a black horizontal streak runs through the eye.',
            'A musky of 20 to 35 pounds is not unusual, and they may grow over four feet long.',
        ],
        habitat: [
    ...
    },
    {
        ...
        lifespan: [
            'Pumpkinseeds spawn in late May to early June. The males clear small, saucer-shaped nests on the bottom in water three feet deep or less. Pumpkinseeds nest in small groups of up to three nests, but these groups of nests can be very close. The nests may have several thousand eggs each, which have been deposited by several females. Although the nest is guarded, other males may rush in and fertilize eggs. It takes about three days for the eggs to hatch, and each nest may produce more than 14,000 young pumpkinseeds.',
            'Pumpkinseeds may hybridize with bluegills and green, redbreast, longear and other sunfish. They feed heavily on snails and have special throat structures for doing so. Pumpkinseeds feed mostly on the bottom of a stream or pond, where they also eat burrowing and other aquatic insects. Like the bluegill, small baits, jigs and flies take pumpkinseeds best.',
        ],
    },
    {
        ...QUILLBACK,
        overview: [
            'One of the quillback’s common names is “quillback carpsucker.” “Quillback” refers to the lengthy first dorsal rays and several following rays that form a long projection at the leading edge of the back fin, which might remind some of a quill pen or feather quill. “Carpsucker” is also appropriate because this sucker does look much like a carp. Its genus name “Carpiodes” means “carplike,” and its species name “cyprinus” is the generic name of the carp.',
            'Quillbacks are uncommon even though they range from the Great Lakes and St. Lawrence River south along the Atlantic Coast to Virginia. They are present in the Mississippi River watershed, and in Gulf Coast watersheds. They are in all of Pennsylvania’s major watersheds. Quillbacks are the only carpsuckers now living in the state’s waters.',
        ],
        characteristics: [
            'Quillbacks have a body that is deep when viewed from the side, but narrow when seen from the front (laterally compressed). The back color is olive-brown to grayish, with the sides silvery. The large, reflective scales add hints of shimmering-green or blue. The dorsal fin is long, stretching along the back nearly to the tail fin. The first several rays of the dorsal fin are very long, about five times longer than the short rays on the rear portion of the fin. The high front portion of the dorsal fin looks like a pointed projection and trails over the fish’s back. There are no sharp spines on any of the fins.',
            'The quillback’s pelvic fins are white to orange, and the head is small and conical. Quillbacks have typical sucker mouths. The upper jaw does not extend beyond the front of the eye. The tail is deeply forked. Quillbacks grow to about two feet long and about 12 pounds.',
        ],
        habitat: [
        ...
        lifespan: [
            ...
            'Mortality is high among the eggs, fry and young fish, because they provide forage for predatory fish. Among adult quillbacks, mortality is 60 to 70 percent annually.',
            'Quillbacks feed on the bottom, with aquatic insect larvae and other small animal organisms the bulk of their diet. They also eat mollusks, like fingernail clams, and some aquatic vegetation. Quillbacks travel in schools.',
        ],
    },
    {
        commonName: 'Rainbow Trout',
        ...
        characteristics: [
            ...
            'At spawning time, males become deeply colored with an intensely red side stripe. Steelhead can be separated from similar-looking coho and chinook salmon by looking at the inside of the mouth. The mouth is completely white in the steelhead.',
            'In the salmons, the mouth has some gray or black. Steelhead and other deepwater, big-lake rainbows are more silvery than stream fish, with less of a side stripe. Great Lakes steelhead can grow to 30 inches and larger. The state record, taken from Lake Erie, is over 19 pounds.',
        ],
        habitat: [
            'Rainbows are considered fast water fish, preferring the swift runs and riffle areas of streams. They may live in small creeks, as well as suitable spots in large rivers, the tailwaters of dams, and in lakes and reservoirs. As trout, rainbows live in cold, clean, well-oxygenated water. Their optimum water temperature is about 55 degrees. Although they do best when the water is under 70 degrees, they can withstand temperatures into the 70s if there is plenty of oxygen and a cool, shady place to which they can retreat.',
            'Rainbows are the trout least tolerant of acidity. They do best in slightly alkaline waters. As steelhead, rainbows inhabit the cool waters of large lakes, especially Lake Erie and other Great Lakes, as well as oceans. Rainbow trout respond well to hatchery culture and have been introduced for sport fishing throughout the world. In some places, especially the mountains of the southeastern United States, introduced rainbows have encroached on native brook trout populations.',
        ],
        lifespan: [
            'Rainbow trout are considered spring spawners, but steelhead may enter streams to spawn from late fall through spring. Spawning takes place when the water temperature is about 50 degrees, over gravel beds with good water flow. Rainbow trout move upstream to find the proper spawning area. Rainbows in lakes seek tributary streams. Like other trout, the female rainbow prepares the nest depression by turning on her side and “kicking” against the bottom gravel with her body and fins.',
            'Male rainbows are aggressive on the spawning grounds, driving other males away from the female’s nest. When the actual spawning takes place, several males may be beside the female. The females produce several hundred to over 12,000 eggs, depending on their size. After the eggs are deposited into the gravel and fertilized, no parental care is given. The eggs hatch in four to seven weeks. The fry take up to another week in the gravel to absorb the yolk sac. Then they become free- swimming.',
            'Most rainbows are sexually mature when they reach about three to five years old. Documentation of successful natural reproduction in Pennsylvania is rare. Self-sustaining populations of rainbow trout are found only in a few scattered streams. But mature rainbows, especially steelhead that have run up Lake Erie tributaries, successfully spawn and produce young. However, adult returns are mostly comprised of hatchery-released fish.',
    ...
    },
    {
        ...
        lifespan: [
            'Except during the spawning season, the redbreast sunfish moves very little from its home area. Spawning is in spring and summer, usually June, when the water temperature reaches 68 degrees. Male redbreast sunfish fan a shallow nest of about 12 inches in diameter in gravel or sand. They guard the eggs and protect the young for a short while after the eggs hatch. The males construct a single nest, but the nests may be grouped in closely packed colonies, when appropriate bottom material is in short supply.',
            'The females deposit 3,300 or more eggs, depending on their size. Redbreast sunfish hybridize with bluegills and other sunfish. The redbreast feeds on aquatic insects and terrestrial insects that fall onto the water, including large ones like mayflies and dragonflies. They also eat crayfish and small fish. They are active in cooler water than the bluegill.',
            'Although widespread, redbreast sunfish don’t become as locally abundant as other sunfishes, and they are normally loners when the water is warm. When the water cools, redbreasts form schools.',
        ],
    },
    {
        ...
        characteristics: [
            'The robust-looking smallmouth has a brownish or bronze cast to its back. It is lighter on the sides and has a white or pale-yellow belly. There is a goldish sheen to its scales, and smallmouths have a series of eight to 15 olive-colored vertical, broken bars along each side. The end of the upper jaw of a smallmouth does not extend beyond the back edge of the eye. The dorsal fin sections are separated by a shallow notch, not a deep notch as in the largemouth.',
            'The smallmouth’s eye is orange-red, and dark lines radiate from the eye backward. In young smallmouths, the vertical side bars are prominent, and the tail fin has three colors: Orange at the base, then a black band, then white to yellow at the tip.',
        ],
        habitat: [
            'Although largemouths and smallmouths may live in the same rivers or lakes, they are found in different habitats. Smallmouths prefer rocky locations, more water depth and heavier current than largemouths. In Pennsylvania, smallmouth bass are found in medium to large streams and clear, deep lakes and reservoirs with a summer water temperature between 60 and 80 degrees.',
            'In lakes, they hang around downed logs, stumps, stone rubble and rock outcrops, and along the steep sides of submerged creek channels. They prefer streams with riffles flowing over gravel or boulders, where they are found in the pools, pockets behind rocks, or in the deeper moving water.',
        ],
        lifespan: [
    ...
    },
    {
        ...HYBRID_STRIPED_BASS,
        overview: [
            'The striped bass hybrid is a hatchery-created cross between a white bass and a striped bass. It is stocked primarily because it tolerates warmer water than the purebred striped bass, which, as it grows older and larger, requires well-oxygenated water during the summer.',
            'In Pennsylvania it is stocked mostly in the western part of the state, in reservoirs such as Lake Arthur and Shenango Lake, and in the big-river area of the Ohio and Allegheny rivers near Pittsburgh. Here the hybrid typically grows larger than the white bass.',
            'Fisheries managers in the state do not tend to stock the striped bass hybrid in lakes and rivers that lead to Delaware or Chesapeake bays to minimize the chance of the hybrids mixing and reproducing with wild marine striped bass.',
        ],
        characteristics: [
    ...
    },
    {
        ...
        characteristics: [
            ...
            'Striped bass have two dorsal fins, the front spiny-rayed, the second mostly soft-rayed, separated by a notch. The back of the tongue has two tooth patches, unlike the white bass, which has one tooth patch at the base of its tongue. There are three spines and 11 soft rays on the anal fin, with the longest of these spines less than half the height of the anal fin.',
    ...
    },
    {
        ...
        overview: [
            'Walleyes are native to central North America and Canada, including the Ohio River and Great Lakes watersheds. Popular sport fish, they have been extensively stocked. In Pennsylvania they are now found throughout the state, including the Susquehanna and Delaware River watersheds, as well as their original Allegheny River and Lake Erie watershed homes. One of the walleye’s nicknames is “Susquehanna salmon.”',
            'It has also been called “yellow pike” and even “pickerel.” All these nicknames put it in the wrong fish family–it’s neither a pike cousin nor a salmon. It’s the biggest, toothiest member of the perch family.',
            'The name “walleye” refers to the fish’s large, milky eye that looks luminous when light is shined on it. The eye has a reflecting membrane behind the retina, which causes this effect. The species name “vitreum” means “glassy,” and refers to the luminous eye.',
        ],
        characteristics: [
    ...
    },
    {
        ...
        lifespan: [
            ...
            'They seldom go into very shallow water, where minnows are abundant, but remain in deep water by day and near shore at sundown. In marine habitats, white perch eat small fish, squid, crabs and shrimp.',
        ],
    },
    {
        ...WHITE_SUCKER,
        overview: [
            'The white sucker is found across Pennsylvania. It is the most common and widely distributed sucker in the state. Its natural range is from northern Canada to Florida, throughout the uplands of eastern North America, and west to the Plains region. It grows large enough to be sought by anglers, who usually fish for them during the white sucker’s spring spawning run.',
            'The genus name “Catostomus” means “inferior mouth,” referring to the bottom position of the mouth on the head. The species name “commersoni” recognizes an early French naturalist, P. Commerson.',
        ],
        characteristics: [
            'White suckers have a stout cylindrical or tube-shaped body. They reach a maximum length of about 24 inches and five pounds. The upper part of the head and back is olive-brown, shading to light-yellow. There is a dull, silvery sheen on the scales on the sides, and the belly is whitish.',
            'In the white sucker, the lower lip is wider than it is high, and is split into two parts. The rounded snout projects very little, or not at all, beyond the tip of the fleshy upper lip. There is a single dorsal fin with 10 to 13 soft rays. During spawning, the male white sucker’s back becomes olive with a bright-lavender sheen, and there is a band of pink or red along each side.',
        ],
        habitat: [
